...
import { SmartEmptyState } from '@/components/modules/projects/SmartEmptyState';
  ...
  return (
    <div className="space-y-4">
      ...
      {projectGoals.length === 0 ? (
        <SmartEmptyState
          type="goals"
          onPrimaryAction={() => {/* AI suggest goals - future feature */}}
          onSecondaryAction={() => setIsCreateGoalOpen(true)}
        />
      ) : (
