...
import { HealthStatusPill } from '@/components/modules/projects/HealthStatusPill';
import { DeadlineCounter } from '@/components/modules/projects/DeadlineCounter';
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 mb-4 flex-wrap">
        ...
        {/* Health Status Pill — shows when health data is available */}
        {(project as Record<string, unknown>).health_status && (
          <HealthStatusPill
            status={(project as Record<string, unknown>).health_status as HealthStatus}
            score={(project as Record<string, unknown>).health_score as number | undefined}
            size="sm"
          />
        )}
        {project.due_date && (
          <DeadlineCounter dueDate={project.due_date} />
        )}
      </div>
